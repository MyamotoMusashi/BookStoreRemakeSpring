...
public class MyAuthorRepository {
    private ArrayList<AuthorServiceModel> authorsList = new ArrayList<AuthorServiceModel>();

    private AuthorServiceModel author1 = new AuthorServiceModel(this.authorsList.size() + 1, "George R.R Martin", "George Raymond Richard Martin[1] (born George Raymond Martin; September 20, 1948),[2] also known as GRRM,[3] is an American novelist, screenwriter, television producer and short story writer. He is the author of the series of epic fantasy novels A Song of Ice and Fire, which were adapted into the Emmy Award-winning HBO series Game of Thrones (2011–2019) and its prequel series House of the Dragon (2022–present). He also helped create the Wild Cards anthology series, and contributed worldbuilding for the 2022 video game Elden Ring.\n" +
            "\n" +
